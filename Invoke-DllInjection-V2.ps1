# this script is 100% fully the work of original authors here: https://github.com/PowerShellMafia/PowerSploit
# the original script, Invoke-DLLinjection.ps1 (now archived), was producing an error related to the variable \$getprocaddress
# i stumbled upon a proposed solution on a forum which, for the time being, solves this problem, see: https://community.ine.com/t/invoke-dllinjection/681
# to be clear I take NO credit for the creation of either the original script or the fix, 
# i am merely hosting them in an integrated form here for the purpose of my course on threat hunting
# faan|ross
